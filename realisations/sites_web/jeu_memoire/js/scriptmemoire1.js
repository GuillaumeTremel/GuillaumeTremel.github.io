...
function melangerImgCaches()
{
	...
	var tabImgOrdre = new Array(0,1,2,3,4,5,6,7);
	
	tabImgMelange = new Array(8);  // tabImgRdm
...
function cacherImages(no)
{
	...
	// variable, on serait obligé d'écrire 8 fois cette ligne
